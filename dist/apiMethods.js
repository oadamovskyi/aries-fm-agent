...
var getSchema = function (agent, id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, agent.ledger.getSchema(id)];
...
var getCredentialDefinition = function (agent, id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, agent.ledger.getCredentialDefinition(id)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
exports.getCredentialDefinition = getCredentialDefinition;
var createCredentnialDefinition = function (agent, schema) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, agent.ledger.registerCredentialDefinition({
                    schema: schema,
...
exports.createCredentnialDefinition = createCredentnialDefinition;
var createSchema = function (agent, attributes, version, name) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, agent.ledger.registerSchema({
...
var createCredentialOffer = function (agent, credentialDefinitionId, attributes) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, agent.credentials.createOffer({
                    protocolVersion: "v1",
                    credentialFormats: {
                        indy: {
...
var createCredentialOfferWithConnection = function (agent, credentialDefinitionId, attributes, connectionId) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, agent.credentials.offerCredential({
                    protocolVersion: "v1",
                    credentialFormats: {
                        indy: {
                            credentialDefinitionId: credentialDefinitionId,
