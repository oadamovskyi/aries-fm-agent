...
exports.setupConnectionListener = exports.receiveInvitation = exports.createNewInvitation = exports.getAgent2 = exports.getAgent = void 0;
...
var getAgent2 = function (label, port) {
    if (port === void 0) { port = 3002; }
    return __awaiter(void 0, void 0, void 0, function () {
        var genesisTransaction, config, agent;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    config = {
                        ...
                        publicDidSeed: 'yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy',
                        indyLedgers: [
                            {
