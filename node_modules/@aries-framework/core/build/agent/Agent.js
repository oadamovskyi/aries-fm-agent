...
const action_menu_1 = require("../modules/action-menu");
...
class Agent {
    constructor(initialConfig, dependencies, injectionContainer) {
        ...
        this.actionMenu = this.dependencyManager.resolve(action_menu_1.ActionMenuModule);
        ...
        this.messageSubscription = this.eventEmitter
            ...
            .pipe(operators_1.takeUntil(this.agentConfig.stop$), operators_1.concatMap((e) => this.messageReceiver
    ...
    registerDependencies(dependencyManager) {
        ...
        dependencyManager.registerModules(ConnectionsModule_1.ConnectionsModule, CredentialsModule_1.CredentialsModule, ProofsModule_1.ProofsModule, MediatorModule_1.MediatorModule, RecipientModule_1.RecipientModule, BasicMessagesModule_1.BasicMessagesModule, QuestionAnswerModule_1.QuestionAnswerModule, action_menu_1.ActionMenuModule, GenericRecordsModule_1.GenericRecordsModule, LedgerModule_1.LedgerModule, discover_features_1.DiscoverFeaturesModule, DidsModule_1.DidsModule, WalletModule_1.WalletModule, OutOfBandModule_1.OutOfBandModule, module_1.IndyModule);
    }
}
exports.Agent = Agent;
