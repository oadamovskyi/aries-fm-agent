...
let MessageSender = class MessageSender {
    constructor(envelopeService, transportService, messageRepository, logger, didResolverService, didCommDocumentService, outOfBandRepository) {
    ...
    async sendMessage(outboundMessage, options) {
        ...
        if (!connection.did) {
            ...
            throw new error_1.MessageSendingError(`Unable to send message using connection '${connection.id}' that doesn't have a did`, { outboundMessage });
        }
        ...
        throw new error_1.MessageSendingError(`Message is undeliverable to connection ${connection.id} (${connection.theirLabel})`, { outboundMessage });
    }
...
MessageSender = __decorate([
    ...
    __metadata("design:paramtypes", [EnvelopeService_1.EnvelopeService,
        ...
        repository_1.OutOfBandRepository])
], MessageSender);
