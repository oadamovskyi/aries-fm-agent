...
export declare class ConnectionService {
    ...
    private logger;
    constructor(wallet: Wallet, config: AgentConfig, connectionRepository: ConnectionRepository, didRepository: DidRepository, eventEmitter: EventEmitter);
    /**
     ...
     */
    createRequest(outOfBandRecord: OutOfBandRecord, config: ConnectionRequestParams): Promise<ConnectionProtocolMsgReturnType<ConnectionRequestMessage>>;
     ...
     */
    createResponse(connectionRecord: ConnectionRecord, outOfBandRecord: OutOfBandRecord, routing?: Routing): Promise<ConnectionProtocolMsgReturnType<ConnectionResponseMessage>>;
    /**
     ...
     */
    createTrustPing(connectionRecord: ConnectionRecord, config?: {
    ...
    updateState(connectionRecord: ConnectionRecord, newState: DidExchangeState): Promise<void>;
    ...
    findByTheirDid(did: string): Promise<ConnectionRecord | null>;
    findByOurDid(did: string): Promise<ConnectionRecord | null>;
    findAllByOutOfBandId(outOfBandId: string): Promise<ConnectionRecord[]>;
    findAllByConnectionType(connectionType: [ConnectionType | string]): Promise<ConnectionRecord[]>;
    ...
    createConnection(options: ConnectionRecordProps): Promise<ConnectionRecord>;
    private createDid;
