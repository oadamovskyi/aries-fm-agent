...
let ConnectionService = class ConnectionService {
    ...
    async processRequest(messageContext, outOfBandRecord) {
        this.logger.debug(`Process message ${messages_1.ConnectionRequestMessage.type.messageTypeUri} start`, messageContext);
    ...
    async processResponse(messageContext, outOfBandRecord) {
        this.logger.debug(`Process message ${messages_1.ConnectionResponseMessage.type.messageTypeUri} start`, messageContext);
    ...
    async findAllByConnectionType(connectionType) {
