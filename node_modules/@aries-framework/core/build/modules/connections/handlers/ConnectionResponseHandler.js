...
class ConnectionResponseHandler {
    constructor(agentConfig, connectionService, outOfBandService, didResolverService) {
    ...
    async handle(messageContext) {
        ...
        const outOfBandRecord = connectionRecord.outOfBandId && (await this.outOfBandService.findById(connectionRecord.outOfBandId));
        if (!outOfBandRecord) {
