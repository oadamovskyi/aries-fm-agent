...
function findMatchingEd25519Key(x25519Key, didDocument) {
    ...
    return allKeyReferences
        .map((keyReference) => dids_1.keyReferenceToKey(didDocument, keyReference.id))
        .filter((key) => (key === null || key === void 0 ? void 0 : key.keyType) === crypto_1.KeyType.Ed25519)
        .find((keyEd25519) => {
        const keyX25519 = dids_1.Key.fromPublicKey(ed25519_1.convertPublicKeyToX25519(keyEd25519.publicKey), crypto_1.KeyType.X25519);
