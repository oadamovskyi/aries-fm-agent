...
const indyProofRequest_1 = require("../../../utils/indyProofRequest");
...
let ProofService = class ProofService {
    constructor(proofRepository, ledgerService, wallet, agentConfig, indyHolderService, indyVerifierService, indyRevocationService, connectionService, eventEmitter, credentialRepository) {
    ...
    async createProposal(connectionRecord, presentationProposal, config) {
        ...
        const proposalMessage = new messages_1.ProposePresentationMessage({
            ...
            parentThreadId: config === null || config === void 0 ? void 0 : config.parentThreadId,
        });
        // Create record
    ...
    async createProposalAsResponse(proofRecord, presentationProposal, config) {
        ...
        await this.updateState(proofRecord, ProofState_1.ProofState.ProposalSent);
        return { message: proposalMessage, proofRecord };
    }
    /**
    ...
    async createRequestAsResponse(proofRecord, proofRequest, config) {
        ...
        indyProofRequest_1.checkProofRequestForDuplicates(proofRequest);
        // Assert
    ...
    async createRequest(proofRequest, connectionRecord, config) {
        ...
        const proofRecord = new ProofRecord_1.ProofRecord({
            ...
            parentThreadId: (_a = requestPresentationMessage.thread) === null || _a === void 0 ? void 0 : _a.parentThreadId,
    ...
    async getRequestedAttachmentsForRequestedCredentials(indyProofRequest, requestedCredentials) {
        ...
        for (const [referent, requestedAttribute] of Object.entries(requestedCredentials.requestedAttributes)) {
            ...
            if (!requestedAttribute.credentialInfo) {
                ...
                requestedAttribute.credentialInfo = JsonTransformer_1.JsonTransformer.fromJSON(indyCredentialInfo, credentials_1.IndyCredentialInfo);
            }
     ...
     */
    async getRequestedCredentialsForProofRequest(proofRequest, config = {}) {
        var _a;
            ...
            // If we have a proposal we will use that to determine the credentials to use
                ...
                credentialMatch = credentials.filter((credential) => {
                    ...
                    return names.every((name) => {
                        var _a;
                        return (_a = config.presentationProposal) === null || _a === void 0 ? void 0 : _a.attributes.find((a) => a.name === name &&
    ...
    async getRevocationStatusForRequestedItem({ proofRequest, requestedItem, credential, }) {
        var _a;
    ...
    emitStateChangedEvent(proofRecord, previousState) {
...
ProofService = __decorate([
    ...
    __param(2, plugins_1.inject(constants_1.InjectionSymbols.Wallet)),
