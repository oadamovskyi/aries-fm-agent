...
let ProofsModule = ProofsModule_1 = class ProofsModule {
    constructor(dispatcher, proofService, connectionService, routingService, agentConfig, messageSender, proofResponseCoordinator) {
    ...
    async getRequestedCredentialsForProofRequest(proofRecordId, config) {
        ...
        return this.proofService.getRequestedCredentialsForProofRequest(indyProofRequest, {
            ...
            filterByNonRevocationRequirements: (_c = config === null || config === void 0 ? void 0 : config.filterByNonRevocationRequirements) !== null && _c !== void 0 ? _c : true,
        });
    }
    /**
    ...
    registerHandlers(dispatcher) {
        ...
        dispatcher.registerHandler(new handlers_1.RequestPresentationHandler(this.proofService, this.agentConfig, this.proofResponseCoordinator, this.routingService));
    ...
    static register(dependencyManager) {
        // Api
        dependencyManager.registerContextScoped(ProofsModule_1);
        // Services
        dependencyManager.registerSingleton(services_1.ProofService);
        // Repositories
        dependencyManager.registerSingleton(repository_1.ProofRepository);
    }
};
ProofsModule = ProofsModule_1 = __decorate([
    plugins_1.module(),
