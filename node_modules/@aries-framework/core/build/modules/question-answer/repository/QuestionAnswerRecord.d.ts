...
export declare type CustomQuestionAnswerTags = TagsBase;
export declare type DefaultQuestionAnswerTags = {
    connectionId: string;
    role: QuestionAnswerRole;
    state: QuestionAnswerState;
    threadId: string;
};
export declare type QuestionAnswerTags = RecordTags<QuestionAnswerRecord>;
