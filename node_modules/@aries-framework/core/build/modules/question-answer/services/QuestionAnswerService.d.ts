...
export declare class QuestionAnswerService {
    ...
    private logger;
    constructor(questionAnswerRepository: QuestionAnswerRepository, eventEmitter: EventEmitter, agentConfig: AgentConfig);
    /**
     ...
     */
    createQuestion(connectionId: string, config: {
        question: string;
     ...
     */
    createAnswer(questionAnswerRecord: QuestionAnswerRecord, response: string): Promise<{
     ...
     */
    getByThreadAndConnectionId(connectionId: string, threadId: string): Promise<QuestionAnswerRecord>;
    /**
     ...
     */
    findByThreadAndConnectionId(connectionId: string, threadId: string): Promise<QuestionAnswerRecord | null>;
    /**
     ...
     *
     */
    getById(questionAnswerId: string): Promise<QuestionAnswerRecord>;
    /**
     * Retrieve a question answer record by id
     *
     * @param questionAnswerId The questionAnswer record id
