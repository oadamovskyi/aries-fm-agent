...
function verkeyToDidKey(key) {
    ...
    const ed25519Key = Key_1.Key.fromPublicKeyBase58(publicKeyBase58, crypto_1.KeyType.Ed25519);
...
function verkeyToInstanceOfKey(verkey) {
    const ed25519Key = Key_1.Key.fromPublicKeyBase58(verkey, crypto_1.KeyType.Ed25519);
    return ed25519Key;
}
