...
class OutOfBandInvitation extends AgentMessage_1.AgentMessage {
    ...
    get invitationDids() {
        const dids = this.getServices().map((didOrService) => {
            ...
            return peerDidNumAlgo2_1.outOfBandServiceToNumAlgo2Did(didOrService);
        });
        return dids;
    }
...
__decorate([
    ...
    messageType_1.IsValidMessageType(OutOfBandInvitation.type),
    __metadata("design:type", Object)
], OutOfBandInvitation.prototype, "type", void 0);
__decorate([
    class_transformer_1.Expose({ name: 'goal_code' }),
    __metadata("design:type", String)
], OutOfBandInvitation.prototype, "goalCode", void 0);
__decorate([
    class_transformer_1.Transform(({ value }) => value === null || value === void 0 ? void 0 : value.map(messageType_1.replaceLegacyDidSovPrefix), { toClassOnly: true }),
    class_transformer_1.Expose({ name: 'handshake_protocols' }),
...
__decorate([
    ...
    validators_1.IsStringOrInstance(OutOfBandDidCommService_1.OutOfBandDidCommService, { each: true }),
