...
let OutOfBandService = class OutOfBandService {
    ...
    async processHandshakeReuse(messageContext) {
        ...
        if (!outOfBandRecord.reusable) {
            await this.updateState(outOfBandRecord, OutOfBandState_1.OutOfBandState.Done);
        }
    ...
    async createHandShakeReuse(outOfBandRecord, connectionRecord) {
    ...
    async save(outOfBandRecord) {
        return this.outOfBandRepository.save(outOfBandRecord);
    }
    async updateState(outOfBandRecord, newState) {
    ...
    emitStateChangedEvent(outOfBandRecord, previousState) {
    ...
    async findById(outOfBandRecordId) {
        return this.outOfBandRepository.findById(outOfBandRecordId);
    }
    async getById(outOfBandRecordId) {
