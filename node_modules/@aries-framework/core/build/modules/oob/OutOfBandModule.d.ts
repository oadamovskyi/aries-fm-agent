...
import { HandshakeProtocol, ConnectionsModule } from '../../modules/connections';
...
export declare class OutOfBandModule {
     ...
     */
    parseInvitation(invitationUrl: string): OutOfBandInvitation;
    /**
     ...
     * @returns OutOfBandInvitation
     */
    parseInvitationShortUrl(invitation: string): Promise<OutOfBandInvitation>;
    /**
