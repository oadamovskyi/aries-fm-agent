...
const MessageDeliveryMessage_1 = require("../messages/MessageDeliveryMessage");
class MessageDeliveryHandler {
    ...
    async handle(messageContext) {
        ...
        if (deliveryReceivedMessage) {
            return helpers_1.createOutboundMessage(connection, deliveryReceivedMessage);
        }
    }
}
exports.MessageDeliveryHandler = MessageDeliveryHandler;
//# sourceMappingURL=MessageDeliveryHandler.js.map