...
let IndyStorageService = IndyStorageService_1 = class IndyStorageService {
    ...
    transformFromRecordTagValues(tags) {
        ...
        for (const [key, value] of Object.entries(tags)) {
            ...
            // '1' or '0' syntax
            else if (type_1.isBoolean(value)) {
    ...
    indyQueryFromSearchQuery(query) {
        ...
        $and = (_a = $and) === null || _a === void 0 ? void 0 : _a.map((q) => this.indyQueryFromSearchQuery(q));
        $or = (_b = $or) === null || _b === void 0 ? void 0 : _b.map((q) => this.indyQueryFromSearchQuery(q));
    ...
    /** @inheritDoc */
    async deleteById(recordClass, id) {
        try {
