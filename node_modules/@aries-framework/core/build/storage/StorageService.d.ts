...
export declare type SimpleQuery<T extends BaseRecord> = Partial<ReturnType<T['getTags']>> & TagsBase;
interface AdvancedQuery<T extends BaseRecord> {
    $and?: Query<T>[];
    $or?: Query<T>[];
    $not?: Query<T>;
}
export declare type Query<T extends BaseRecord<any, any, any>> = AdvancedQuery<T> | SimpleQuery<T>;
