...
class WsOutboundTransport {
    constructor() {
        ...
        this.handleMessageEvent = (event) => {
            ...
            if (!utils_1.isValidJweStructure(payload)) {
    ...
    async start(agent) {
        this.agent = agent;
        const agentConfig = agent.dependencyManager.resolve(AgentConfig_1.AgentConfig);
        this.logger = agentConfig.logger;
        this.eventEmitter = agent.dependencyManager.resolve(EventEmitter_1.EventEmitter);
